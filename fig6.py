...
ax1b.plot(t_gA1_simvals, gBMH_A1_simvals, label = "$g_{BMH}(A_1)$", ls = "solid", lw = 3, color = "green")
ax1b.plot(t_gA2_simvals, gBMH_A2_simvals, label = "$g_{BMH}(A_2)$", ls = "solid", lw = 3, color = "blue")
ax1b.plot(t_gPf_simvals, gBMH_Pf_simvals, label = "$g_{BMH}(P_f)$", ls = "solid", lw = 3, color = "red")
...
ax2b.plot(t_gA1_simvals, gGC_A1_simvals, label = "$g_{BGC}(A_1)$", ls = "solid", lw = 3, color = "green")
ax2b.plot(t_gA2_simvals, gGC_A2_simvals, label = "$g_{BGC}(A_2)$", ls = "solid", lw = 3, color = "blue")
ax2b.plot(t_gPf_simvals, gGC_Pf_simvals, label = "$g_{BGC}(P_f)$", ls = "solid", lw = 3, color = "red")
